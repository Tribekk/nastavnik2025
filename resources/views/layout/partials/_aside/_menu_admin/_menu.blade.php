...
<li class="menu-item menu-item-submenu @if(request()->is('admin/reports/*')) menu-item-open @endif " aria-haspopup="true" data-menu-toggle="hover">
    ...
    <div class="menu-submenu" kt-hidden-height="200" style="">
        <i class="menu-arrow"></i>
        <ul class="menu-subnav">
            <x-menu-item link="{{ route('admin.reports.students_tests') }}" title="{{ __('Ход тестирования наставников') }}" icon="la la-minus" />
            <x-menu-item link="{{ route('admin.reports.students') }}" title="{{ __('Наставники') }}" icon="la la-minus" />
            <x-menu-item link="{{ route('admin.reports.registrations') }}" title="{{ __('Регистрации') }}" icon="la la-minus" />
            <x-menu-item link="{{ route('admin.reports.student_questionnaires') }}" title="{{ __('Анкеты наставников') }}" icon="la la-minus" />
...
<x-menu-item link="{{ route('employer.students.list') }}" title="{{ __('Сводная таблица наставников') }}" icon="la la-list-alt"></x-menu-item>
