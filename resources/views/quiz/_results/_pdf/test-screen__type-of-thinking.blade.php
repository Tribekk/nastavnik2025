...
{{--            </div>--}}
            ...
            <div class="row">
                ...
                <div class="col-md-12 order-1 order-md-0">
                    <div class="progress mb-5 bg-transparent my-3" style="position: relative; width: 100%; height: 18px;line-height: 18px">
                        ...
                        <div style="margin-bottom:5px;margin-left: {{ $typeThinkingValuesEndAverage }}%;font-size: 18px;color:{{ $typeThinkingValuesEndAverageColor }};font-weight: bold;z-index: 3">{{ $typeThinkingValuesEndAverage }}</div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 order-1 order-md-0 mb-10">
                    <div class="progress mb-5 bg-transparent my-3" style="position: relative; width: 100%; height: 18px;line-height: 18px">
                        ...
                        <div style="margin-bottom:5px;margin-left: {{ $PersonalThinkingTypesAverage }}%;font-size: 18px;color:{{ $PersonalThinkingTypesAverageColor }};font-weight: bold">{{ $PersonalThinkingTypesAverage }}</div>
            ...
            @foreach($PersonalThinkingTypes as $value)
                <div class="row" style="margin-top:20px">
                    ...
                    <div class="col-md-7">
                        <span class="text-dark font-size-h5 {{ $value->percentage > 70 ? 'font-weight-bold' : '' }}">{{ $value->type->title }}</span>
                    </div>
                </div>
            @endforeach
            ...
            <div class="row">
                ...
                <div class="col-md-12 order-1 order-md-0">
                    <div class="progress mb-5 bg-transparent my-3" style="position: relative; width: 100%; height: 18px;line-height: 18px">
                        ...
                        <div style="margin-bottom:5px;margin-left: {{ $ProfessionalThinkingTypesAverage }}%;font-size: 18px;color:{{ $ProfessionalThinkingTypesAverageColor }};font-weight: bold">{{ $ProfessionalThinkingTypesAverage }}</div>
            ...
            @foreach($ProfessionalThinkingTypes as $value)
                <div class="row" style="margin-top:20px">
                    ...
                    <div class="order-1 order-md-0 col-md-12 mb-10">
                        {{ $value->manifestation->description }}
                    </div>
                </div>
            @endforeach
