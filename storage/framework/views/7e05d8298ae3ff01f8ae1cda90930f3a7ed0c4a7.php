<?php $__env->startSection('content'); ?>
    <div>
        ...
        <form class="form" method="POST" action="<?php echo e(route('register.verify')); ?>">
            ...
            <?php if(session()->has('email_code') && env('APP_ENV') !== 'production'): ?>
...
<?php echo $__env->make('layout.register', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c109133/nastavnik2025.na4u.ru/www/resources/views/auth/register/verify.blade.php ENDPATH**/ ?>