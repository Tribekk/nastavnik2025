...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('KotqTIp')) {
    $componentId = $_instance->getRenderedChildComponentId('KotqTIp');
    $componentTag = $_instance->getRenderedChildComponentTagName('KotqTIp');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('KotqTIp');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('KotqTIp', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
</div>
<?php /**PATH /home/c41010/mentor.na4u.ru/www/resources/views/components/tables/filter-inputs/select2.blade.php ENDPATH**/ ?>