...
<?php $component = $__env->getContainer()->make(App\View\Components\Alert::class, ['type' => 'info','close' => false,'text' => 'На введенную Вами почту был отправлен код для подтверждения смены пароля']); ?>
...
<?php endif; ?> 
            ...
            <?php if(session()->has('email_code')): ?>
                 <?php if (isset($component)) { $__componentOriginald4c8f106e1e33ab85c5d037c2504e2574c1b0975 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Alert::class, ['type' => 'info','text' => ''.e(__('Код из письма: ' . session('email_code'))).'','close' => false]); ?>
<?php $component->withName('alert'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?> <?php if (isset($__componentOriginald4c8f106e1e33ab85c5d037c2504e2574c1b0975)): ?>
...
<?php echo $__env->make('layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c109133/nastavnik2025.na4u.ru/www/resources/views/auth/passwords/reset.blade.php ENDPATH**/ ?>