...
<x-tables.filter-inputs.select2 classes="col-md-4"
                                ...
                                indexUrl="{{ route('admin.orgunits.legal_forms.view') }}"
                                showUrl="/admin/orgunits/legal_forms"
...
<x-tables.filter-inputs.select2 classes="col-md-4"
                                ...
                                indexUrl="{{ route('admin.orgunits.activity_kinds.view') }}"
                                showUrl="/admin/orgunits/activity_kinds"
