...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('lBC4mTB')) {
    $componentId = $_instance->getRenderedChildComponentId('lBC4mTB');
    $componentTag = $_instance->getRenderedChildComponentTagName('lBC4mTB');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('lBC4mTB');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('lBC4mTB', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php /**PATH /home/c109133/nastavnik2025.na4u.ru/www/resources/views/user/type/_employer-form.blade.php ENDPATH**/ ?>