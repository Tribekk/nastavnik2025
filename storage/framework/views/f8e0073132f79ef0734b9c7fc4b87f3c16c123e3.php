...
} elseif ($_instance->childHasBeenRendered('d1fuilS')) {
    $componentId = $_instance->getRenderedChildComponentId('d1fuilS');
    $componentTag = $_instance->getRenderedChildComponentTagName('d1fuilS');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('d1fuilS');
} else {
    $response = \Livewire\Livewire::mount('employer.sync-reports-data', ['label' => ''.e($latestSyncDataLabel).'']);
    $html = $response->html();
    $_instance->logRenderedChild('d1fuilS', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
