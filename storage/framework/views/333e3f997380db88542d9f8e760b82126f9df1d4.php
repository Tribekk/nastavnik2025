...
} elseif ($_instance->childHasBeenRendered('IXXS6Vn')) {
    $componentId = $_instance->getRenderedChildComponentId('IXXS6Vn');
    $componentTag = $_instance->getRenderedChildComponentTagName('IXXS6Vn');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('IXXS6Vn');
} else {
    $response = \Livewire\Livewire::mount('school.select-school-class', []);
    $html = $response->html();
    $_instance->logRenderedChild('IXXS6Vn', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/c109133/nastavnik2025.na4u.ru/www/resources/views/user/type/_student-form.blade.php ENDPATH**/ ?>