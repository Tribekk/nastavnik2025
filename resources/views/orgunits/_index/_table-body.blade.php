    ...
    <tr class="font-size-lg">
        ...
        <td>
            <div class="d-flex align-items-center min-w-225px max-w-225px">
                ...
                <div class="ml-4">
                    <a href="{{ route('orgunits.edit', $orgunit) }}" class="font-weight-bolder link text-break">
                        {!! $orgunit->title !!}
                    </a>
                </div>
            </div>
        ...
        <td>
            <div class="d-flex align-items-center min-w-225px max-w-225px">
                @if($orgunit->parent)
                    ...
                    <div class="ml-4">
                        <a href="{{ route('orgunits.edit', $orgunit->parent) }}" class="font-weight-bolder link text-break">
        ...
        <td class="">
            @foreach($orgunit->activityKinds as $activityKind)
                <div>{{ $activityKind->activityKind->title }}</div>
            @endforeach
        </td>
