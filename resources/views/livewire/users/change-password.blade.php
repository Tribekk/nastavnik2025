<div>
    <form wire:submit.prevent="updatePassword">
        <div class="pb-13 pt-lg-0 pt-5">
            <h3 class="font-weight-bolder text-primary font-size-h4 font-size-h1-lg">{{ __('Смена пароля') }}</h3>
        </div>
        ...
        <div class="form-group">
            <label for="password-confirm" class="font-size-h6 font-weight-bolder text-dark required">{{ __('Новый пароль еще раз') }}</label>
            <input
