...
} elseif ($_instance->childHasBeenRendered('s7eAQur')) {
    $componentId = $_instance->getRenderedChildComponentId('s7eAQur');
    $componentTag = $_instance->getRenderedChildComponentTagName('s7eAQur');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('s7eAQur');
} else {
    $response = \Livewire\Livewire::mount('user.notification', ['notification' => $notification]);
    $html = $response->html();
    $_instance->logRenderedChild('s7eAQur', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
