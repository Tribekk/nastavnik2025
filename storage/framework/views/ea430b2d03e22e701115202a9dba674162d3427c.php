...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('2JKyfdC')) {
    $componentId = $_instance->getRenderedChildComponentId('2JKyfdC');
    $componentTag = $_instance->getRenderedChildComponentTagName('2JKyfdC');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('2JKyfdC');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('2JKyfdC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
