            ...
            <div class="card card-custom">
                <div class="card-header">
                    <div class="card-title font-weight-bold font-size-h3 font-hero-super">
                        Редактирование критериев отбора (углубленный тест) профиля "{{ $userProfile->title }}"
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('user_profiles.deep_test_items_update',$deepTestItems->first()->id) }}" method="POST" >
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="background-color:#38957B">
                                                                ...
                                                                @include('admin.user_profiles.include.deep_test_inclinations_form')
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="background-color:#38957B">
                                                                @php
                                                                    $type="green"
                                                                @endphp
                                                        @include('admin.user_profiles.include.deep_test_types_thinking')
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="background-color:#38957B">
                                                                @php
                                                                    $type="green"
                                                                @endphp
                                                                @include('admin.user_profiles.include.deep_test_intellegense_levels')
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="background-color:#38957B">
                                                                @php
                                                                    $type="green"
                                                                @endphp
                                                                @include('admin.user_profiles.include.deep_test_intellegense_levels_types')
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="background-color:#38957B">
                                                                @php
                                                                    $type="green"
                                                                @endphp
                                                                @include('admin.user_profiles.include.deep_test_situations')
