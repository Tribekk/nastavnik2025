...
} elseif ($_instance->childHasBeenRendered('s8NIy7E')) {
    $componentId = $_instance->getRenderedChildComponentId('s8NIy7E');
    $componentTag = $_instance->getRenderedChildComponentTagName('s8NIy7E');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('s8NIy7E');
} else {
    $response = \Livewire\Livewire::mount('school.select-school-class', []);
    $html = $response->html();
    $_instance->logRenderedChild('s8NIy7E', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/c41010/mentor.na4u.ru/www/resources/views/user/type/_student-form.blade.php ENDPATH**/ ?>