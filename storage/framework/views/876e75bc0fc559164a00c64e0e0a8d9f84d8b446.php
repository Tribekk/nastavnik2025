                        ...
                        <div class="row">
                            <div class="col-12 col-md-4">
                                ...
                                <form method="post" class="align-self-end mb-8 md-md-0" action="<?php echo e(route('quiz.start', $availableQuiz)); ?>">
                                    <?php echo csrf_field(); ?>
                                    <button class="btn btn-info px-md-10 text-white py-4 px-5 font-size-h3 font-weight-bolder my-2 rounded-pill col-12"><?php echo e($availableQuiz->quiz->title == "Кейсы" ? 'Решить кейсы' : 'Ответить на вопросы'); ?></button>
                                </form>
                            </div>
...
<?php echo $__env->make('layout.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\openserver\OpenServer\domains\prof\www\resources\views/quiz/description.blade.php ENDPATH**/ ?>