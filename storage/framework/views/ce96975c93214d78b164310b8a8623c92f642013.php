...
<?php $component = $__env->getContainer()->make(App\View\Components\Tables\FilterInputs\Select::class, ['classes' => 'col-md-4','name' => 'parent_questionnaire','id' => 'parent_questionnaire','label' => 'Заполнена анкета руководителя','items' => [['title' => 'Показать все', 'value' => 'all'], ['title' => 'Заполнена', 'value' => 'finished'], ['title' => 'Не заполнена', 'value' => 'not_finished']],'value' => ''.e(request()->parent_questionnaire).'']); ?>
...
<?php endif; ?> 
 ...
 <?php if (isset($component)) { $__componentOriginalc50993156ccf2819e884fe38ba86d52a90faf26b = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Tables\FilterInputs\Select::class, ['classes' => 'col-md-4','name' => 'student_questionnaire','id' => 'student_questionnaire','label' => 'Заполнена анкета наставника','items' => [['title' => 'Показать все', 'value' => 'all'], ['title' => 'Заполнена', 'value' => 'finished'], ['title' => 'Не заполнена', 'value' => 'not_finished']],'value' => ''.e(request()->student_questionnaire).'']); ?>
<?php $component->withName('tables.filter-inputs.select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?> <?php if (isset($__componentOriginalc50993156ccf2819e884fe38ba86d52a90faf26b)): ?>
...
<?php if(request('type') != 'base_test'): ?>
     <?php if (isset($component)) { $__componentOriginalc50993156ccf2819e884fe38ba86d52a90faf26b = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Tables\FilterInputs\Select::class, ['classes' => 'col-md-4','name' => 'base_tests','id' => 'base_tests','label' => 'Базовый тест','items' => [
...
<?php if(request('type') != 'got_consultation'): ?>
     <?php if (isset($component)) { $__componentOriginalc50993156ccf2819e884fe38ba86d52a90faf26b = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Tables\FilterInputs\Select::class, ['classes' => 'col-md-4','name' => 'child_got_consultation','id' => 'child_got_consultation','label' => 'Наставник получил консультацию','items' => [['title' => 'Показать все', 'value' => 'all'], ['title' => 'Получил', 'value' => 'carried_out'], ['title' => 'Приглашен', 'value' => 'invited'], ['title' => 'Не получил', 'value' => 'not_invited']],'value' => ''.e(request()->child_got_consultation).'']); ?>
<?php $component->withName('tables.filter-inputs.select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?> <?php if (isset($__componentOriginalc50993156ccf2819e884fe38ba86d52a90faf26b)): ?>
...
<?php endif; ?> 
     ...
     <?php if (isset($component)) { $__componentOriginalc50993156ccf2819e884fe38ba86d52a90faf26b = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Tables\FilterInputs\Select::class, ['classes' => 'col-md-4','name' => 'got_consultation_with_parent','id' => 'got_consultation_with_parent','label' => 'Руководитель получил консультацию','items' => [['title' => 'Показать все', 'value' => 'all'], ['title' => 'Получил', 'value' => 'carried_out'], ['title' => 'Приглашен', 'value' => 'invited'], ['title' => 'Не получил', 'value' => 'not_invited']],'value' => ''.e(request()->got_consultation_with_parent).'']); ?>
<?php $component->withName('tables.filter-inputs.select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?> <?php if (isset($__componentOriginalc50993156ccf2819e884fe38ba86d52a90faf26b)): ?>
...
<?php endif; ?> 
 ...
 <?php if (isset($component)) { $__componentOriginalc50993156ccf2819e884fe38ba86d52a90faf26b = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Tables\FilterInputs\Select::class, ['classes' => 'col-md-4','name' => 'agree','id' => 'agree','label' => 'Согласен присвоить статус наставника','items' => [['title' => 'Показать все', 'value' => 'all'], ['title' => 'Согласен', 'value' => 'agree'], ['title' => 'Думает', 'value' => 'think'], ['title' => 'Не согласен', 'value' => 'not_agree']],'value' => ''.e(request()->agree).'']); ?>
<?php $component->withName('tables.filter-inputs.select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?> <?php if (isset($__componentOriginalc50993156ccf2819e884fe38ba86d52a90faf26b)): ?>
...
<?php /**PATH /home/c41010/mentor.na4u.ru/www/resources/views/employer/reports/_students/search.blade.php ENDPATH**/ ?>