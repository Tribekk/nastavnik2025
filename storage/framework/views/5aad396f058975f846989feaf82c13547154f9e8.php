...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('Tt7BdV5')) {
    $componentId = $_instance->getRenderedChildComponentId('Tt7BdV5');
    $componentTag = $_instance->getRenderedChildComponentTagName('Tt7BdV5');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Tt7BdV5');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('Tt7BdV5', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('LPNi0QU')) {
    $componentId = $_instance->getRenderedChildComponentId('LPNi0QU');
    $componentTag = $_instance->getRenderedChildComponentTagName('LPNi0QU');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LPNi0QU');
} else {
    $response = \Livewire\Livewire::mount('user.attach.select-teacher-type', ['role' => ''.e(old('role', 'teacher')).'']);
    $html = $response->html();
    $_instance->logRenderedChild('LPNi0QU', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php /**PATH /home/c41010/mentor.na4u.ru/www/resources/views/user/type/_teacher-form.blade.php ENDPATH**/ ?>