<div class="mr-5 mb-5 order rounded shadow-sm p-10 w-100 md-w-50" xmlns:wire="http://www.w3.org/1999/xhtml">
    ...
    <div class="d-flex justify-content-between">
        ...
        <div class="d-flex flex-column justify-content-around col-md-6">
            ...
            <?php else: ?>
                <div class="text-dark-50 font-size-lg font-hero mb-3 text-center" style="width: min-content">
            ...
            <?php if (! ($availableQuiz->state->fillable())): ?>
                <a href="<?php echo e(route('quiz.result', $availableQuiz)); ?>" role="button" class="btn btn-sm btn-success" style="width: min-content">
                    Результаты
                </a>
            <?php endif; ?>
...
<?php /**PATH /home/c109133/nastavnik2025.na4u.ru/www/resources/views/livewire/quiz/quiz-card.blade.php ENDPATH**/ ?>