...
} elseif ($_instance->childHasBeenRendered('l1192786762-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1192786762-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1192786762-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1192786762-0');
} else {
    $response = \Livewire\Livewire::mount('quiz.suitable-professions', ['availableQuiz' => $availableQuiz]);
    $html = $response->html();
    $_instance->logRenderedChild('l1192786762-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php else: ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/c109133/nastavnik2025.na4u.ru/www/resources/views/livewire/quiz/run-quiz.blade.php ENDPATH**/ ?>