...
} elseif ($_instance->childHasBeenRendered('qcEyYQ2')) {
    $componentId = $_instance->getRenderedChildComponentId('qcEyYQ2');
    $componentTag = $_instance->getRenderedChildComponentTagName('qcEyYQ2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('qcEyYQ2');
} else {
    $response = \Livewire\Livewire::mount('users.account', ['user' => $user]);
    $html = $response->html();
    $_instance->logRenderedChild('qcEyYQ2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php /**PATH /home/c41010/mentor.na4u.ru/www/resources/views/admin/users/_edit/_user-tab.blade.php ENDPATH**/ ?>