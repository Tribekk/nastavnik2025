...
} elseif ($_instance->childHasBeenRendered('o4iHHt1')) {
    $componentId = $_instance->getRenderedChildComponentId('o4iHHt1');
    $componentTag = $_instance->getRenderedChildComponentTagName('o4iHHt1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('o4iHHt1');
} else {
    $response = \Livewire\Livewire::mount('quiz.run-quiz', ['availableQuiz' => $availableQuiz]);
    $html = $response->html();
    $_instance->logRenderedChild('o4iHHt1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
...
<?php echo $__env->make('layout.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/mentor.na4u.ru/www/resources/views/quiz/show.blade.php ENDPATH**/ ?>