    ...
    <div class="max-w-md-550px">
        <div class="row mt-3">
            <div class="col-sm-6 text-center position-relative cursor-pointer" wire:click="setRole('curator')">
                <img src="<?php echo e(asset('img/curator.jpg')); ?>" class="img-fluid" alt="HR">
...
<?php /**PATH /home/c109133/nastavnik2025.na4u.ru/www/resources/views/livewire/user/attach/select-teacher-type.blade.php ENDPATH**/ ?>