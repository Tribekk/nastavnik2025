...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('qM1cGFr')) {
    $componentId = $_instance->getRenderedChildComponentId('qM1cGFr');
    $componentTag = $_instance->getRenderedChildComponentTagName('qM1cGFr');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('qM1cGFr');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('qM1cGFr', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('GayDyTb')) {
    $componentId = $_instance->getRenderedChildComponentId('GayDyTb');
    $componentTag = $_instance->getRenderedChildComponentTagName('GayDyTb');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('GayDyTb');
} else {
    $response = \Livewire\Livewire::mount('components.select2', ['name' => 'type_of_educational_organization_id','id' => 'type_of_educational_organization','url' => ''.e(route('admin.types_of_educational_organization.view')).'','event' => 'setTypeEducationalOrganization','placeholder' => ''.e(__('Укажите отрасль деятельности компании')).'','selected' => ''.e(old('type_of_educational_organization_id', $school->type_of_educational_organization_id)).'','selectedItemUrl' => '/admin/types_of_educational_organization']);
    $html = $response->html();
    $_instance->logRenderedChild('GayDyTb', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('0VXN9cS')) {
    $componentId = $_instance->getRenderedChildComponentId('0VXN9cS');
    $componentTag = $_instance->getRenderedChildComponentTagName('0VXN9cS');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('0VXN9cS');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('0VXN9cS', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
