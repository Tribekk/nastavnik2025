...
} elseif ($_instance->childHasBeenRendered('l2992625254-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2992625254-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2992625254-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2992625254-0');
} else {
    $response = \Livewire\Livewire::mount('quiz.suitable-professions', ['availableQuiz' => $availableQuiz]);
    $html = $response->html();
    $_instance->logRenderedChild('l2992625254-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php else: ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\openserver\OpenServer\domains\prof\www\resources\views/livewire/quiz/run-quiz.blade.php ENDPATH**/ ?>