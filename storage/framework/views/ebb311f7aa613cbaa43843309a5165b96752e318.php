...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('TXzi1Wh')) {
    $componentId = $_instance->getRenderedChildComponentId('TXzi1Wh');
    $componentTag = $_instance->getRenderedChildComponentTagName('TXzi1Wh');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('TXzi1Wh');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('TXzi1Wh', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('WYuBGEN')) {
    $componentId = $_instance->getRenderedChildComponentId('WYuBGEN');
    $componentTag = $_instance->getRenderedChildComponentTagName('WYuBGEN');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('WYuBGEN');
} else {
    $response = \Livewire\Livewire::mount('components.select2', ['name' => 'type_of_educational_organization_id','id' => 'type_of_educational_organization','url' => ''.e(route('admin.types_of_educational_organization.view')).'','event' => 'setTypeEducationalOrganization','placeholder' => ''.e(__('Укажите отрасль деятельности компании')).'','selected' => ''.e(old('type_of_educational_organization_id')).'','selectedItemUrl' => '/admin/types_of_educational_organization']);
    $html = $response->html();
    $_instance->logRenderedChild('WYuBGEN', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('onh3Lms')) {
    $componentId = $_instance->getRenderedChildComponentId('onh3Lms');
    $componentTag = $_instance->getRenderedChildComponentTagName('onh3Lms');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('onh3Lms');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('onh3Lms', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layout.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/mentor.na4u.ru/www/resources/views/admin/schools/create.blade.php ENDPATH**/ ?>