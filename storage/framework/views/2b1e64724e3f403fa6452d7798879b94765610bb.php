...
} elseif ($_instance->childHasBeenRendered('Y3DIwSi')) {
    $componentId = $_instance->getRenderedChildComponentId('Y3DIwSi');
    $componentTag = $_instance->getRenderedChildComponentTagName('Y3DIwSi');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Y3DIwSi');
} else {
    $response = \Livewire\Livewire::mount('user.notification', ['notification' => $notification]);
    $html = $response->html();
    $_instance->logRenderedChild('Y3DIwSi', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH /home/c109133/nastavnik2025.na4u.ru/www/resources/views/layout/partials/_header/_notifications.blade.php ENDPATH**/ ?>