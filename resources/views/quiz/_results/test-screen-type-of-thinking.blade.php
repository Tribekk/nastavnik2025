...
{{--            </div>--}}
            ...
            <div class="row">
                ...
                @if ($typeThinkingValuesEndAverage !== 0.0)
                <div class="row">
            ...
            <div class="row">
                ...
                @if ($PersonalThinkingTypesAverage !== 0)
                <div class="row">
                    <div class="col-md-12 order-1 order-md-0">
            ...
            <div class="row">
                ...
                @if ($ProfessionalThinkingTypesAverage !== 0)
                <div class="row">
                    <div class="col-md-12 order-1 order-md-0">
            ...
            @foreach($ProfessionalThinkingTypes as $value)
                ...
                <div class="row">
                    ...
                    <div class="order-1 order-md-0 col-md-12 mb-10">
                        @if($value->manifestation){{ $value->manifestation->description }}@endif
                    </div>
                </div>
            @endforeach
            @endif
